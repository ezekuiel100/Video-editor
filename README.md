...
- **`stt/`** — Whisper (cli + `ggml-small.bin`). Se faltar, o `build-installer.ps1` chama `fetch-stt.ps1`.
...
fetch-stt.ps1       # baixa whisper-cli + ggml-small para stt/
stt/                # Whisper empacotado (nao versionado)

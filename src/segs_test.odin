...
fx_biblioteca_tem_os_tipos_novos :: proc(t: ^testing.T) {
	...
	testing.expect(t, string(fxlib_name(FX_INVERT)) == "Inverter")
	testing.expect(t, string(fxlib_name(FX_WAVE)) == "Onda")
	testing.expect(t, string(fxlib_name(FX_HUE)) == "Matiz")
	testing.expect(t, string(fxlib_name(FX_GLOW)) == "Brilho")
